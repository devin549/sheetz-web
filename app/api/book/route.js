...
export async function POST(request) {
  ...
  const fullNotes = [`🌐 WEB BOOKING — confirm a time.`, qa, plateLine, notes].filter(Boolean).join('\n');
  const base = { customer_id: customerId, job_type: service, status: 'hold', notes: fullNotes };

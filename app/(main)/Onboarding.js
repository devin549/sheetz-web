        ...
        {step === 0 && (
          <div style={cardStyle}>
            ...
            <div style={{ background: 'rgba(255,179,0,0.06)', borderLeft: '3px solid var(--amber-dim)', padding: '8px 12px', fontSize: 11.5, color: 'var(--fg-2)', lineHeight: 1.7, borderRadius: '0 6px 6px 0', marginBottom: 12 }}>
              <strong style={{ color: 'var(--amber)' }}>Plain English:</strong> Calls you make to a customer via the iPad are recorded; texts are saved; video walkthroughs go to Drive; AI (Hank, Pete) reads transcripts; and your <strong>live location is shared with dispatch while you’re on shift</strong> (so we can route you the closest job/part). Recordings retained <strong>7 years</strong> per CB policy + KY one-party consent (KRS 526.010). Reviewers: Devin (Owner), Ronnie (GM), Field Supervisors, automated AI.
            </div>

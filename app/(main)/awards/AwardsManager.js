        ...
        {awards.map((a) => editing === a.id ? (
          ...
          <div key={a.id} className="card" style={{ display: 'flex', alignItems: 'center', gap: 12, opacity: a.active ? 1 : 0.55 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: 700 }}>{a.title} <span className="pill" style={{ fontSize: 10 }}>{a.kind}</span>{!a.active && <span className="pill pill-red" style={{ fontSize: 10, marginLeft: 4 }}>off</span>}</div>

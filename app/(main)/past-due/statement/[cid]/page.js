      ...
      <div style={P.page}>
        <div style={P.sheet}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '2px solid #111', paddingBottom: 14 }}>
            <div>
              <div style={{ fontSize: 19, fontWeight: 800 }}>Clog Busterz Plumbing</div>
              <div style={{ fontSize: 11, color: '#666' }}>Accounts Receivable</div>
            </div>
          ...
          <div style={{ marginTop: 18, paddingTop: 12, borderTop: '1px solid #eee', fontSize: 12, color: '#444' }}>
            Please remit payment for the balance due. Questions about this statement? Contact our office and we’ll be glad to help — payment plans are available.
          </div>
          <div style={{ marginTop: 16, fontSize: 10.5, color: '#999' }}>Generated by Clog Busterz Plumbing on {today}.</div>
        </div>
      </div>
    </div>
  );

...
`window` — reserved word.) Current queued migrations: 09 techs_crew, 10 job_photo_spine. Next after
that: job_activity+work_orders, leads, bookings, truck_transfers+tool_loans, realtime.

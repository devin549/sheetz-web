...
// no close-out, no payment collection, no commission, no estimates, no pricing. Their "day" is the
// PAIRED TECH's jobs (office pairs helper↔tech daily in _DB_HelperAssign). Most-limited field seat.
ROLES.helper = {

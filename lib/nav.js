...
// 'tech' (field screens), 'shop' (Reed — inventory, reorder, self-issue review).
// A user's role lives in their Supabase user_metadata.role.

export const NAV = [
  { href: '/',          label: 'Home',      icon: '🏠', roles: ['owner', 'office', 'tech', 'shop'] },
  { href: '/my-day',    label: 'My Day',    icon: '📋', roles: ['owner', 'tech'] },
  { href: '/my-truck',  label: 'My Truck',  icon: '🚐', roles: ['owner', 'tech', 'shop'] },
  { href: '/shop',      label: 'Shop',      icon: '🏪', roles: ['owner', 'shop'] },

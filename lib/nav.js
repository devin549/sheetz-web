...
export const NAV = [
  ...
  // Estimate = Good/Better/Best price-book presenter (ported). PRESENT_ROLES: field + office + sales.
  { href: '/estimate',  label: 'Estimate',  icon: '🧾', show: (r) => ['owner', 'admin', 'gm', 'om', 'accounting', 'fs', 'foreman', 'tech', 'helper', 'dispatcher', 'csr', 'sales', 'marketing'].includes(String(r || '').toLowerCase()) },

...
const LIVE = {
  ...
  photoReview: '/supervisor/jobs', openEstimates: '/open-estimates', priceBook: '/estimate', marketing: '/campaigns', opportunities: '/opportunities',
  shopCounter: '/shop', inventory: '/shop', shopDash: '/shop', fleet: '/my-truck', equipment: '/equipment', toolReg: '/tools', teams: '/team', account: '/account',
  // Field Ops + Reports screens (live with real data)
  staffScore: '/scorecard', techPerf: '/scorecard', billableHours: '/billable-hours', crewRoles: '/crews', helperAssign: '/crews', crewTeams: '/team',
  ...
  growth: '/growth', myPay: '/pay', awards: '/awards', payStructure: '/pay-structure', referrals: '/referrals', rankTracker: '/rank-tracker', leadFinder: '/leads', reviewIntel: '/competitors', territory: '/territory', contentEngine: '/content', brainKb: '/brain-kb', pricebookAdmin: '/pricebook-admin',
  // Shop module
...
const GROUPS = [
  {
    ...
    items: [
      ...
      { key: 'opportunities', label: 'Opportunities', icon: 'star' },
...
// Rail order = the workday (Devin, from the GAS board): the DAILY DRIVERS pinned on top — Dispatch,
// Booking, Web Leads, Messages — never buried under utilities. Hank/Meetings/On-Call ride below them.
const OFFICE_ROLES_DAILY = ['dispatcher', 'csr', 'om', 'fs', 'foreman', 'sales', 'marketing'];
const OFFICE_PINNED = [
  { key: 'home', label: 'Dashboard', icon: 'home', roles: OFFICE_ROLES_DAILY },
  { key: 'board', label: 'Dispatch Live', icon: 'truck', roles: OFFICE_ROLES_DAILY },
  { key: 'booking', label: 'Job Booking', icon: 'phone', roles: OFFICE_ROLES_DAILY },
  { key: 'webLeads', label: 'Web Leads', icon: 'phone', roles: OFFICE_ROLES_DAILY },
  { key: 'messages', label: 'Messages', icon: 'phone', roles: OFFICE_ROLES_DAILY },
  { key: 'callDesk', label: 'Call Desk', icon: 'phone', roles: OFFICE_ROLES_DAILY },
  { key: 'schedule', label: 'Schedule', icon: 'calendar', roles: OFFICE_ROLES_DAILY },
...
const OFFICE_GROUPS = [
  ...
  { id: 'money', title: 'Money & AR', icon: 'star', roles: ['accounting', 'om'], items: [
    ...
    { key: 'billableHours', label: 'Billable Hours', icon: 'chart' },
  ] },
  ...
  { id: 'salesGrp', title: 'Sales & Marketing', icon: 'flame', roles: ['sales', 'marketing', 'om'], items: [
    ...
    { key: 'brainKb', label: 'Brain Knowledge', icon: 'flame' },
    { key: 'pricebookAdmin', label: 'Pricebook Editor', icon: 'list' },
    { key: 'reviews', label: 'Reviews', icon: 'star' },

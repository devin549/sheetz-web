...
const LIVE = {
  ...
  topCustomers: '/top-customers', profitTruth: '/revenue', askBoard: '/ask', leakRadar: '/leak-radar', helperWaste: '/helper-waste',
  ...
  growth: '/growth', myPay: '/pay', awards: '/awards', payStructure: '/pay-structure',
  // Shop module

...
const LIVE = {
  ...
  payrollRun: '/payroll', docFraud: '/doc-fraud', cashCustody: '/cash-custody', settings: '/settings', messages: '/messages', importExport: '/import', mergeDuplicates: '/reconcile',
...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'mergeDuplicates', label: 'Merge Duplicates', icon: 'users' },

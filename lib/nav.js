...
const LIVE = {
  ...
  payrollRun: '/payroll', docFraud: '/doc-fraud', cashCustody: '/cash-custody', settings: '/settings',
  ...
  purchaseOrders: '/purchase-orders', vendorList: '/vendors', vendorPrices: '/vendors',
};

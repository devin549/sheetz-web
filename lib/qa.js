...
// Gate helper: returns a blocking reason string, or null if the job may go 'done'. Enforces BOTH the
// media/QA gate and the disposition checklist (both fail open until their tables exist).

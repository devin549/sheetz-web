...
export const AUDIENCES = [
  ...
  { key: 'opp_declined', label: '📄 Declined estimates', desc: 'Customers who declined an estimate — offer it again' },
  { key: 'opp_recs',     label: '📌 Flagged recommendations', desc: 'Customers a tech flagged for follow-up work' },
...
const AUDIENCE_BRIEF = {
  ...
  opp_declined: `These customers were quoted work and DECLINED. Warmly re-open the door — no pressure. Remind them we're still here when they're ready, offer a limited-time coupon to make it easier, and invite them to reply with any questions. Never guilt them; make it feel like a helpful nudge.`,
  opp_recs: `On a recent visit our tech recommended additional work these customers haven't done yet. Gently remind them what we flagged and why it matters (prevent a bigger problem / bigger bill later), and invite them to schedule. Include a coupon and a free-assessment offer. Helpful, not pushy.`,
};
